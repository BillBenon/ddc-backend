 ...
 *         description: Not found
 */
router.get("/user/:id", [AUTH_MIDDLEWARE, isUserCategory([USER_CATEGORY_ENUM.SYSTEM_ADMIN, USER_CATEGORY_ENUM.CUSTOMER, USER_CATEGORY_ENUM.EMPLOYEE])], async (req, res) => {
